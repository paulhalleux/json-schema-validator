...
export function createValidationContext(
  ...
  return t.variableDeclaration("const", [
    t.variableDeclarator(
      t.identifier("validationContext"),
      t.objectExpression([
        ...
        t.objectProperty(t.identifier("rootSchema"), t.identifier("schema")),
        t.objectProperty(t.identifier("validator"), t.identifier("validator")),
        t.objectProperty(
